      ...
      <section style={{ padding: "0 24px 32px", maxWidth: "min(1280px, calc(100vw - 48px))", margin: "0 auto" }}>
        <FadeUp>
          <div style={{
            ...
            {/* Image side — replace src with a local file when available:
                  e.g. src={`${base}/workstation.jpg`}
                  Until then a CSS gradient visual is used. */}
            <div style={{
              position: "relative", minHeight: 280, overflow: "hidden",
              background: `
                repeating-linear-gradient(160deg, rgba(255,255,255,0.06) 0 2px, transparent 2px 28px),
                radial-gradient(circle at 65% 40%, rgba(34,197,94,0.14), transparent 14rem),
                linear-gradient(135deg, #06070a, #1e2226 52%, #08090c)
              `,
              filter: "grayscale(1)",
            }}>
              <div style={{
